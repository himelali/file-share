...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">View all sub categories of <?php echo $category->sub_cat_name; ?></h3>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo site_url("categories/subsubcategory/delete/$item->ssc_id"); ?>" data-toggle="tooltip" class="text-danger" title="Remove">
...
<div class="modal fade" id="addnew" tabindex="-1" role="dialog" aria-labelledby="Add New Category">
    <div class="modal-dialog" role="form">
        <div class="modal-content">
            ...
            <form id="addCategory" class="form-horizontal" action="<?php echo site_url("categories/subsubcategory/insert/$category->sub_cat_id"); ?>" method="post" enctype="multipart/form-data">
                <div class="box-body">
