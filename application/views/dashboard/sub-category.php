<section class="content-header">
    <h1>
        Sub Category
        <small>All Sub Categories</small>
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">View all sub categories of <?php echo $category->cat_name; ?></h3>
        ...
        <div class="box-body">
            <table class="table table-striped">
                ...
                ?>
                        <tr>
                            <td><?php echo ++$sl; ?>.</td>
                            <td><a href="<?php echo site_url("categories/subsubcategory/view/$item->sub_cat_id"); ?>" data-toggle="tooltip" title="View Sub categories"><?php echo $item->sub_cat_name; ?></a></td>
                            <td><?php echo $item->sub_cat_desc; ?></td>
                            <td>
                                ...
                                <a href="<?php echo site_url("categories/subcategory/delete/$item->sub_cat_id"); ?>" data-toggle="tooltip" class="text-danger" title="Remove">
...
<div class="modal fade" id="addnew" tabindex="-1" role="dialog" aria-labelledby="Add New Category">
    <div class="modal-dialog" role="form">
        <div class="modal-content">
            ...
            <form id="addCategory" class="form-horizontal" action="<?php echo site_url("categories/subcategory/insert/$category->cat_id"); ?>" method="post" enctype="multipart/form-data">
                <div class="box-body">
